...
# Updated CSS: Deep Stealth Black + Slim Status Widget + Shimmer
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;1,700&display=swap');
    
    /* Replace Navy with Deep Stealth Black/Charcoal */
    .stApp {
        background-color: #0a0a0a;
    }
    
    /* Slim Status Widget refinement */
    .status-widget {
    ...
    /* Global Shimmer for Signature and Status */
    .shimmer-gold {
...
with col_map:
    ...
    components.html(map_svg, height=500)
