...
Or use the scripts: `./run_nrrfc_coal_8051.sh`, `./run_nrrfc_dashboard_8051.sh`, `./run_coal_corridor_8052.sh`, `./run_strike_command_8053.sh`, `./run_awc_portal_8054.sh`. See **PROJECT_AUDIT.md** for full audit and space-safe commands.
