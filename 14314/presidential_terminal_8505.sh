...
STATE_FILE="$ROOT/14314/presidential_terminal_8505.state"
...
refresh_state() {
  {
    echo "alias=presidential_terminal_8505"
...
echo "presidential_terminal_8505 watchdog active (ports 8505/8506)."
while true; do
