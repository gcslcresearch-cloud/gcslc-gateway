...
STATE_FILE="$ROOT/14314/presidential_terminal_8505_FINAL_STABLE.state"
...
refresh_state() {
  {
    echo "alias=presidential_terminal_8505_FINAL_STABLE"
...
echo "presidential_terminal_8505_FINAL_STABLE watchdog active (ports 8505/8506; tunnel 8505 only)."
while true; do
